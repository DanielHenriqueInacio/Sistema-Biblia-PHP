...
<div class="container py-4 py-xl-5">
    <div class="row mb-5">
        <div class="col-md-8 col-xl-6 text-center mx-auto">
            <form class="d-flex"><input class="border rounded form-control" type="text" autofocus=""
                                        placeholder="Busque aqui ...">
                <button class="btn btn-primary border rounded float-end" type="button">Buscar</button>
            </form>
        </div>
    </div>
</div>
